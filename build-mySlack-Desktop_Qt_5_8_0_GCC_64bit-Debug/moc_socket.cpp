...
QT_MOC_LITERAL(6, 54, 12), // "disconnected"
QT_MOC_LITERAL(7, 67, 12), // "bytesWritten"
QT_MOC_LITERAL(8, 80, 5), // "bytes"
QT_MOC_LITERAL(9, 86, 9) // "readyRead"

    },
    "MyTcpSocket\0newMessage\0\0message\0"
    "sendMessage\0connected\0disconnected\0"
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTcpSocket::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::newMessage(QString _t1)
{
